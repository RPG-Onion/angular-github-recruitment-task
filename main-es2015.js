...
/* harmony import */ var _Services_Github_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Services/Github.service */ "./src/app/GithubModue/Services/Github.service.ts");
/* harmony import */ var _Store_Effects_Github_effects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Store/Effects/Github.effects */ "./src/app/GithubModue/Store/Effects/Github.effects.ts");
/* harmony import */ var _Store_Reducers_Github_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Store/Reducers/Github.store */ "./src/app/GithubModue/Store/Reducers/Github.store.ts");
/* harmony import */ var _Store_Reducers_GithubUser_reducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Store/Reducers/GithubUser.reducer */ "./src/app/GithubModue/Store/Reducers/GithubUser.reducer.ts");
...
GithubModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: GithubModule });
GithubModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function GithubModule_Factory(t) { return new (t || GithubModule)(); }, providers: [_Services_Github_service__WEBPACK_IMPORTED_MODULE_4__["GithubService"]], imports: [[
            _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"],
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["EffectsModule"].forFeature([_Store_Effects_Github_effects__WEBPACK_IMPORTED_MODULE_5__["GithubEffects"]]),
            _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["StoreModule"].forFeature(_Store_Reducers_Github_store__WEBPACK_IMPORTED_MODULE_6__["githubFeatureKey"], _Store_Reducers_GithubUser_reducer__WEBPACK_IMPORTED_MODULE_7__["GithubUserReducer"]),
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](GithubModule, { imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["EffectsFeatureModule"], _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["StoreFeatureModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](GithubModule, [{
...
class GithubService {
    ...
    getUser(username) {
        ...
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(null)));
    }
    getUsersRepositories(user) {
        return this.http.get(user.repos_url, {
            headers: this.headers
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])([])));
    }
...
GithubService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: GithubService, factory: GithubService.ɵfac });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchUserError", function() { return fetchUserError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchUsersRepos", function() { return fetchUsersRepos; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchUsersReposSuccess", function() { return fetchUsersReposSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchUsersReposError", function() { return fetchUsersReposError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchRepoBranches", function() { return fetchRepoBranches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchRepoBranchesSuccess", function() { return fetchRepoBranchesSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchRepoBranchesError", function() { return fetchRepoBranchesError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GithubActions", function() { return GithubActions; });
...
const fetchRepoBranches = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Github] Get Repo`s branches', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const fetchRepoBranchesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Github] Get Repo`s branches Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const fetchRepoBranchesError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Github] Get Repo`s branches Error');
const GithubActions = {
    User: {
        Load: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GithubEffects", function() { return GithubEffects; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _Actions_Github_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Actions/Github.actions */ "./src/app/GithubModue/Store/Actions/Github.actions.ts");
/* harmony import */ var _Services_Github_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Services/Github.service */ "./src/app/GithubModue/Services/Github.service.ts");
...
class GithubEffects {
    constructor(actions$, githubService, store) {
        ...
        this.fetchGithubUsersReposBranches = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_4__["GithubActions"].User.Repos.Branches.Fetch), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((action) => this.githubService.getRepoBranches(action.repo)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((branches) => _Actions_Github_actions__WEBPACK_IMPORTED_MODULE_4__["GithubActions"].User.Repos.Branches.Success({ branches, repo: action.repo })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_4__["GithubActions"].User.Repos.Branches.Error))))));
    }
}
GithubEffects.ɵfac = function GithubEffects_Factory(t) { return new (t || GithubEffects)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["Actions"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_Services_Github_service__WEBPACK_IMPORTED_MODULE_5__["GithubService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_6__["Store"])); };
GithubEffects.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: GithubEffects, factory: GithubEffects.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GithubEffects, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["Actions"] }, { type: _Services_Github_service__WEBPACK_IMPORTED_MODULE_5__["GithubService"] }, { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_6__["Store"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "githubFeatureKey", function() { return githubFeatureKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "repositoryAdapter", function() { return repositoryAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "branchAdapter", function() { return branchAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialGithubState", function() { return initialGithubState; });
...
/* harmony import */ var _lib_Store_Common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../lib/Store/Common */ "./src/lib/Store/Common.ts");


const githubFeatureKey = 'github';
const repositoryAdapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_0__["createEntityAdapter"])({
    selectId: model => model.data.node_id,
});
const branchAdapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_0__["createEntityAdapter"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GithubUserReducer", function() { return GithubUserReducer; });
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
/* harmony import */ var _lib_Store_Common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../lib/Store/Common */ "./src/lib/Store/Common.ts");
/* harmony import */ var _Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Actions/Github.actions */ "./src/app/GithubModue/Store/Actions/Github.actions.ts");
/* harmony import */ var _Github_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Github.store */ "./src/app/GithubModue/Store/Reducers/Github.store.ts");




const GithubUserReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(_Github_store__WEBPACK_IMPORTED_MODULE_3__["initialGithubState"], Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["fetchUser"], state => ({
...
})), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["fetchUsersReposSuccess"], (state, action) => ({
    user: Object.assign(Object.assign({}, state.user), { repos: {
            data: _Github_store__WEBPACK_IMPORTED_MODULE_3__["repositoryAdapter"].setAll(action.repos.map(repo => ({
                data: repo,
                branches: {
...
})), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["fetchUsersReposError"], state => ({
    user: Object.assign(Object.assign({}, state.user), { repos: {
            data: _Github_store__WEBPACK_IMPORTED_MODULE_3__["repositoryAdapter"].getInitialState(),
            status: Object.assign({}, _lib_Store_Common__WEBPACK_IMPORTED_MODULE_1__["onErrorState"]),
        } })
})), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["fetchRepoBranchesSuccess"], (state, action) => ({
    user: Object.assign(Object.assign({}, state.user), { repos: Object.assign(Object.assign({}, state.user.repos), { data: _Github_store__WEBPACK_IMPORTED_MODULE_3__["repositoryAdapter"].updateOne({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "githubState", function() { return githubState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GithubSelectos", function() { return GithubSelectos; });
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
/* harmony import */ var _Reducers_Github_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Reducers/Github.store */ "./src/app/GithubModue/Store/Reducers/Github.store.ts");


const githubState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_Reducers_Github_store__WEBPACK_IMPORTED_MODULE_1__["githubFeatureKey"]);
const getUser = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(githubState, (state) => state.user.data);
const getUserStatus = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(githubState, (state) => state.user.status);
const getRepos = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(githubState, (state) => state.user.repos.data.entities);
const getReposStatus = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(githubState, (state) => state.user.repos.status);
const getReposBranches = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(githubState, (state, props) => {
    var _a;
    return (_a = state.user.repos.data.entities[props.repoId]) === null || _a === void 0 ? void 0 : _a.branches.data.entities;
});
const GithubSelectos = {
    getUser,
    getUserStatus,
    getRepos,
    getReposStatus,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Github_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Github.module */ "./src/app/GithubModue/Github.module.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GithubModule", function() { return _Github_module__WEBPACK_IMPORTED_MODULE_0__["GithubModule"]; });
...
class HeaderComponent {
    ...
    ngOnInit() {
        this.searchSubscription$ = this.searchSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])()).subscribe(username => {
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 6, vars: 1, consts: [[1, "header"], [1, "container", "header-content"], [1, "brand"], [1, "search"], ["type", "search", "placeholder", "Github login", 1, "search-input", 3, "ngModel", "ngModelChange", "change"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HeaderComponent_Template_input_ngModelChange_5_listener($event) { return ctx.searchPhrase = $event; })("change", function HeaderComponent_Template_input_change_5_listener() { return ctx.searchChangeHandler(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
LayoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LayoutComponent, selectors: [["app-layout"]], ngContentSelectors: _c0, decls: 7, vars: 0, consts: [[1, "layout"], [1, "layout-content", "container"], [1, "footer"], [1, "container"]], template: function LayoutComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RepoTileComponent", function() { return RepoTileComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../GithubModue/Store/Actions/Github.actions */ "./src/app/GithubModue/Store/Actions/Github.actions.ts");
/* harmony import */ var _GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../GithubModue/Store/Selectors/github.selectors */ "./src/app/GithubModue/Store/Selectors/github.selectors.ts");
...
function RepoTileComponent_div_8_div_4_div_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const branch_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("\u00A0", branch_r3.commit.sha, "");
} }
function RepoTileComponent_div_8_div_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
function RepoTileComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    const branches_r1 = ctx.ngIf;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", branches_r1);
} }
class RepoTileComponent {
    constructor(store) {
        this.store = store;
    }
    ngOnInit() {
        if (this.repo) {
            this.store.dispatch(_GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_3__["GithubActions"].User.Repos.Branches.Fetch({ repo: this.repo }));
        }
        this.branches$ = this.store
            .pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(_GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_4__["GithubSelectos"].getReposBranches, { repoId: this.repo.node_id }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(res => Object.values(res)));
    }
}
RepoTileComponent.ɵfac = function RepoTileComponent_Factory(t) { return new (t || RepoTileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"])); };
RepoTileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RepoTileComponent, selectors: [["repo-tile"]], inputs: { repo: "repo" }, decls: 10, vars: 6, consts: [[1, "repo-name"], [4, "ngIf"], [4, "ngFor", "ngForOf"]], template: function RepoTileComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RepoTileComponent, [{
    ...
    }], function () { return [{ type: _ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"] }]; }, { repo: [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReposListComponent", function() { return ReposListComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
/* harmony import */ var _GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../GithubModue/Store/Actions/Github.actions */ "./src/app/GithubModue/Store/Actions/Github.actions.ts");
/* harmony import */ var _GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../GithubModue/Store/Selectors/github.selectors */ "./src/app/GithubModue/Store/Selectors/github.selectors.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _repo_tile_repo_tile_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../repo-tile/repo-tile.component */ "./src/app/Pages/user-page/Components/repo-tile/repo-tile.component.ts");
...
function ReposListComponent_div_2_span_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Loading ...");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function ReposListComponent_div_2_span_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const status_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().ngIf;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", status_r1.errorMessage || "Error", " ");
} }
function ReposListComponent_div_2_div_3_repo_tile_1_Template(rf, ctx) { if (rf & 1) {
...
function ReposListComponent_div_2_div_3_Template(rf, ctx) { if (rf & 1) {
...
function ReposListComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
class ReposListComponent {
    ...
    ngOnInit() {
        ...
        this.repos$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(_GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_3__["GithubSelectos"].getRepos))
            .subscribe(res => {
            this.repos = Object.values(res)
                .map(reso => reso.data)
                .filter(reso => reso.fork !== true);
        });
        this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(_GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_3__["GithubSelectos"].getUser)).subscribe(user => {
            if (user !== null) {
                this.store.dispatch(_GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["GithubActions"].User.Repos.Fetch({ user }));
            }
        });
    }
    ngOnDestroy() {
...
ReposListComponent.ɵfac = function ReposListComponent_Factory(t) { return new (t || ReposListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"])); };
ReposListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ReposListComponent, selectors: [["app-repos-list"]], decls: 4, vars: 3, consts: [[4, "ngIf"], ["class", "repo-list", 4, "ngIf"], [1, "repo-list"], [3, "repo", 4, "ngFor", "ngForOf"], [3, "repo"]], template: function ReposListComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../GithubModue/Store/Actions/Github.actions */ "./src/app/GithubModue/Store/Actions/Github.actions.ts");
/* harmony import */ var _GithubModue_Store_Selectors_github_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../GithubModue/Store/Selectors/github.selectors */ "./src/app/GithubModue/Store/Selectors/github.selectors.ts");
/* harmony import */ var src_app_router_selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/router.selectors */ "./src/app/router.selectors.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _Components_repos_list_repos_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/repos-list/repos-list.component */ "./src/app/Pages/user-page/Components/repos-list/repos-list.component.ts");
...
function UserPageComponent_div_0_span_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Loading ...");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function UserPageComponent_div_0_span_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function UserPageComponent_div_0_div_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
class UserPageComponent {
    ...
    ngOnInit() {
        this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(Object(src_app_router_selectors__WEBPACK_IMPORTED_MODULE_4__["selectRouteParam"])('username'))).subscribe(username => {
            this.store.dispatch(_GithubModue_Store_Actions_Github_actions__WEBPACK_IMPORTED_MODULE_2__["GithubActions"].User.Load.Fetch({ username }));
        });
...
UserPageComponent.ɵfac = function UserPageComponent_Factory(t) { return new (t || UserPageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"])); };
UserPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserPageComponent, selectors: [["app-user-page"]], decls: 2, vars: 3, consts: [[4, "ngIf"], [1, "user"], [1, "avatar", 3, "src", "alt"], [1, "data"], [3, "href"]], template: function UserPageComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _Pages_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Pages/user-page/user-page.component */ "./src/app/Pages/user-page/user-page.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [_Layout_layout_layout_component__WEBPACK_IMPORTED_MODULE_1__["LayoutComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuc2FzcyJ9 */"] });
...
/* harmony import */ var _GithubModue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./GithubModue */ "./src/app/GithubModue/index.ts");
...
/* harmony import */ var _Layout_layout_layout_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Layout/layout/layout.component */ "./src/app/Layout/layout/layout.component.ts");
/* harmony import */ var _Pages_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Pages/user-page/user-page.component */ "./src/app/Pages/user-page/user-page.component.ts");
/* harmony import */ var _Pages_user_page_Components_repos_list_repos_list_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Pages/user-page/Components/repos-list/repos-list.component */ "./src/app/Pages/user-page/Components/repos-list/repos-list.component.ts");
/* harmony import */ var _Pages_user_page_Components_repo_tile_repo_tile_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Pages/user-page/Components/repo-tile/repo-tile.component */ "./src/app/Pages/user-page/Components/repo-tile/repo-tile.component.ts");
...
const metaReducers = !_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].production ? [] : [];
class AppModule {
}
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [], imports: [[
            ...
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_10__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].production }),
            ...
            _GithubModue__WEBPACK_IMPORTED_MODULE_11__["GithubModule"],
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        ...
        _Pages_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_14__["UserPageComponent"],
        _Pages_user_page_Components_repos_list_repos_list_component__WEBPACK_IMPORTED_MODULE_15__["ReposListComponent"],
        _Pages_user_page_Components_repo_tile_repo_tile_component__WEBPACK_IMPORTED_MODULE_16__["RepoTileComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormsModule"], _ngrx_store__WEBPACK_IMPORTED_MODULE_8__["StoreRootModule"], _ngrx_effects__WEBPACK_IMPORTED_MODULE_9__["EffectsRootModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_10__["ServiceWorkerModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _ngrx_router_store__WEBPACK_IMPORTED_MODULE_3__["StoreRouterConnectingModule"], _ngrx_store_devtools__WEBPACK_IMPORTED_MODULE_6__["StoreDevtoolsModule"], _GithubModue__WEBPACK_IMPORTED_MODULE_11__["GithubModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _Pages_user_page_user_page_component__WEBPACK_IMPORTED_MODULE_14__["UserPageComponent"],
                    _Pages_user_page_Components_repos_list_repos_list_component__WEBPACK_IMPORTED_MODULE_15__["ReposListComponent"],
                    _Pages_user_page_Components_repo_tile_repo_tile_component__WEBPACK_IMPORTED_MODULE_16__["RepoTileComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormsModule"],
...
const selectors = _ngrx_router_store__WEBPACK_IMPORTED_MODULE_0__["getSelectors"](selectRouter);
/**
 * select the current route
 * (custom implementation for better typings)
 */
const selectCurrentRoute = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectRouter, state => state.state.root);
const { selectQueryParams, selectQueryParam, selectRouteParams, selectRouteParam, selectRouteData, selectUrl } = selectors;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommonStoreStatusInit", function() { return CommonStoreStatusInit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onLoadingState", function() { return onLoadingState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onErrorState", function() { return onErrorState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onSuccessState", function() { return onSuccessState; });
const CommonStoreStatusInit = {
    loading: true,
    loaded: false,
    error: false,
    errorMessage: null
...
module.exports = __webpack_require__(/*! C:\Users\rpgon\Desktop\Projects\zadanie2\src\main.ts */"./src/main.ts");
